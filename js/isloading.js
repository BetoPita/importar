    ...
    Plugin.prototype = {
        ...
        show: function() {
            ...
            switch( this.options.position ) {
                ...
                case "overlay":
                    if( $( this.element ).is( "body") ) {
                        $( "body" ).prepend( '<div class="isloading-overlay" style="position:fixed; left:0; top:0; z-index: 30000; background: rgba(0,0,0,0.5); width: 100%; height: ' + $( this.element ).outerHeight() + 'px;" />' );
                    }
                    else {
